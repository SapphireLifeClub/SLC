    ...
    >
      <div className="py-24 md:py-36 lg:py-48">
        ...
        >
          ...
          >
            A Private Network of Exceptional Standing in Newport Beach.
          </h2>
        ...
        <div className="mt-16 md:mt-20 lg:mt-24 mx-auto max-w-[780px] px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            <div className="relative w-full flex items-center justify-center">
              <img
                src={heroImage.src}
                alt={heroImage.alt}
                className="w-[140px] sm:w-[168px] md:w-[196px] lg:w-[224px] h-auto select-none"
              />
            </div>
          </div>
